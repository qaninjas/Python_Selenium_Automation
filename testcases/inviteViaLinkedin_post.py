...
class InviteFromLinkedin(DriverManager):
    def test_invite_from_linkedin(self):
        ...
        self.service.wait_for_element(self.invite_btn.linkedin_btn)
        self.service.click_element(self.invite_btn.linkedin_btn)
        self.service.wait(2)
