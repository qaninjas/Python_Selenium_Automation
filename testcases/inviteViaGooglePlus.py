...
class InviteFromGooglePlus(DriverManager):
    def test_invite_from_googleplus(self):
        ...
        self.service.wait_for_element(self.invite_btn.googlePlus_btn)
        self.service.click_element(self.invite_btn.googlePlus_btn)
        self.service.wait(2)
