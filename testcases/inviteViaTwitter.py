...
class InviteFromTwitter(DriverManager):
    def test_invite_from_twitter(self):
        ...
        self.service.wait_for_element(self.invite_btn.twitter_btn)
        self.service.click_element(self.invite_btn.twitter_btn)
        self.service.wait(2)
